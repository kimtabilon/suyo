...
/* APPBAR */
const appbarSmTitle = TextStyle(
  fontSize: 16.0,
);

/* CATEGORIES */
const themeColorEats = Color(0xffffcc3a);
const themeColorGo = Color(0xff32a5ee);
const themeColorMart = Color(0xff85d86d);
const themeColorMeds = Color(0xffff7140);
